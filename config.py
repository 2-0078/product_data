...
CRAWLING_ITEMS = [
    ...
    {"PRODUCT": "쥬얼리", "URL": "https://kream.co.kr/search?tab=products&price=4000000-&keyword=%EC%A5%AC%EC%96%BC%EB%A6%AC&sort=pricepremium", "MAIN_CATEGORY": "쥬얼리", "SUB_CATEGORY": "명품 브랜드 쥬얼리"}
]
